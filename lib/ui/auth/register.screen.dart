...
class _RegisterScreenState extends State<RegisterScreen> {
              ...
              listeners: [
                ...
                BlocListener<CustomerBloc, CustomerState>(
                  listener: (context, state) {
                    ...
                    if (state is AddUserOtherSuccess) {
                      LoadingHelper.hideLoading(context);
                      debugPrint("AddUserOtherSuccess Success");
                      ToastService.showToast(msg: "Success");
                      Navigator.pop(context);
                    }
                    if (state is AddUserOtherFail) {
                      LoadingHelper.hideLoading(context);
                      ToastService.showToast(
                          msg: state.message,
                          backgroundColor: AppColors.errorBackgroundColor);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextInputLabel(
                      ...
                      validator: (str) =>
                          Validator.validateRequired(str, LocaleKeys.name.tr()),
                      prefixIcon: Icon(
                        Icons.person,
                      ),
                      onChanged: (a) {
                          ...
                          ? () {
                              widget.otherUser == null
                                  ...
                                  : BlocProvider.of<CustomerBloc>(context).add(
                                      AddUserOtherEvent(
                                          otherUser: new RegisterCustomerOther(
                                              gender: selectedGender == 1
                                                  ? "MALE"
                                                  : "FEMALE",
                                              dob: _dobController.text,
  ...
  _validate() {
    if ((RegExp(Validator.REGEX_EMAIL).hasMatch(_emailController.text.trim()) ||
        ...
        (_emailController.text.trim().isNotEmpty || widget.otherUser != null) &&
